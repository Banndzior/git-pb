...
2. [CS Visualized: Useful Git Commands](<https://dev.to/lydiahallie/cs-visualized-useful-git-commands-37p1>)
3. [A Simple, Visual Git Tutorial](<https://agripongit.vincenttunru.com/>)
4. [GIT flow](<https://danielkummer.github.io/git-flow-cheatsheet/>)
5. [GIT mess workflow](<http://justinhileman.info/article/git-pretty/git-pretty.png>)
6. [Oh Shit, Git!?!](<https://ohshitgit.com/en>)
...
9. [A Visual Git Reference](https://marklodato.github.io/visual-git-guide/index-en.html)
